...
import net.teamarcana.horizons.client.entity.animation.HogAnimation;
...
public class HogModel<T extends Entity> extends AgeableHierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(HogAnimation.HOG_WALK, limbSwing, limbSwingAmount, 2, 2);
		this.animate(((Hog) entity).idleAnimationState, HogAnimation.HOG_IDLE, ageInTicks);
		this.animate(((Hog) entity).sitAnimationState, HogAnimation.HOG_LAY, ageInTicks, 1.0F);
		this.animate(((Hog) entity).runAnimationState, HogAnimation.HOG_DASH, ageInTicks);
	}
