...
import net.teamarcana.horizons.init.HorizonMenuTypes;
import net.teamarcana.horizons.inventory.BackpackSlot;
...
public class BackpackMenu extends AbstractContainerMenu {
    ...
    public BackpackMenu(int containerId, Inventory playerInventory, Container container) {
        ...
        for (int k = 0; k < 3; k++) {
            for (int l = 0; l < 9; l++) {
                this.addSlot(new BackpackSlot(container, l + k * 9, 8 + l * 18, 18 + k * 18));
            }
        }
